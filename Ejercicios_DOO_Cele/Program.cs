namespace Ejercicios_DOO_Cele
{
    internal class Program
    {
            ...
            static void Main(string[] args)
            {
                ...
                //      EJERCICIO 2 
                AgregarEmpleado(new EmpleadoPermanente(1, "Juan", "Pérez",500000, 3, 30500));
                AgregarEmpleado(new EmpleadoTemporal(2, "Ana", "Gómez",450000,60, 15000));
                AgregarEmpleado(new EmpleadoPermanente(3, "Carlos", "López",550000,5, 38600.80));
                ...
                AgregarProducto(new ProductoAlimenticio(1, "Leche", 1500, new DateTime(2025, 2, 25)));
                AgregarProducto(new ProductoElectronico(2, "Auriculares", 25000, 12));
                AgregarProducto(new ProductoAlimenticio(3, "Pan", 800, new DateTime(2025, 9, 10)));
                ...
                AgregarPersona(new Alumno(1, "Lucia Fernandez", 20, 1050, 8.5));
                AgregarPersona(new Profesor(2, "Carlos Lopez", 45, "Matematica", 250000));
                AgregarPersona(new Alumno(3, "Martin Diaz", 22, 1103, 7.9));
                AgregarPersona(new Profesor(4, "Ana Gomez", 38, "Historia", 220000.00));
